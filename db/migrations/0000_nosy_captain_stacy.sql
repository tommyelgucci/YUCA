...
ALTER TABLE "sectors" ADD CONSTRAINT "sectors_edition_id_editions_id_fk" FOREIGN KEY ("edition_id") REFERENCES "public"."editions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "stands" ADD CONSTRAINT "stands_sector_id_sectors_id_fk" FOREIGN KEY ("sector_id") REFERENCES "public"."sectors"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "sectors_edition_code_key" ON "sectors" USING btree ("edition_id","code");--> statement-breakpoint
