...
import { artistDisciplines } from '../data/site';
 ...
 *
 * @param {'welcome'|'signup'|'login'} variant Estado inicial al abrirse.
 * @param {(payload: {mode: string, values: object}) => void} onSubmit
 *        Punto de enganche para el backend (hoy sólo muestra la confirmación).
 */
