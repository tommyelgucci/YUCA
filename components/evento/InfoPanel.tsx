import { CalendarDays, MapPin, QrCode, Store } from 'lucide-react';
    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] lg:items-start">
      ...
      <aside className="card p-5">
        ...
        <p className="mb-4 text-sm leading-relaxed text-yuca-ink-soft">
          Crea tu cuenta de expositor, elige tu mesa en el mapa y paga para confirmarla. Una vez
          confirmemos el pago, tu perfil aparece en la lista de participantes.
        </p>
