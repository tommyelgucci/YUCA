...
export const brand = {
  name: 'Proyecto Yuca',
  /**
   * El dominio web. Ojo: NO es el mismo texto que el usuario de redes
   * (`@proyecto_yuca.bo`), que se parece y se confunde a cada rato.
   */
  domain: 'proyectoyuca.com',
...
export const navLinks = [
  ...
  { label: 'Tiendas', href: '/tienda', route: true },
...
export const contacto = {
  ...
  linktree: 'https://linktr.ee/proyecto.yuca.bo',
};
